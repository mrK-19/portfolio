...
int main(){ 
    ...
    fp = fopen("rate.csv", "w");
    episode = 1000;
    for(enemy.hp=240, enemy.maxhp=240; enemy.hp<=420, enemy.maxhp<=420; enemy.hp+=10, enemy.maxhp+=10){
        for(enemy.atk=107; enemy.atk<=177; enemy.atk+=10){
            //Q-learning
            epsilon = 0.3;
